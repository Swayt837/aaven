...
export const BUTTON_TYPES_SERVER = {
  ...
  tiktok: { icon: 'TikTok', label: { fr: 'TikTok', en: 'TikTok' } },
  youtube: { icon: 'Youtube', label: { fr: 'YouTube', en: 'YouTube' } },
  x: { icon: 'Twitter', label: { fr: 'X (Twitter)', en: 'X (Twitter)' } },
  whatsapp: { icon: 'MessageCircle', label: { fr: 'WhatsApp', en: 'WhatsApp' } },
  spotify: { icon: 'Music', label: { fr: 'Spotify', en: 'Spotify' } },
  twitch: { icon: 'Twitch', label: { fr: 'Twitch', en: 'Twitch' } },
  facebook: { icon: 'Facebook', label: { fr: 'Facebook', en: 'Facebook' } },
  snapchat: { icon: 'Ghost', label: { fr: 'Snapchat', en: 'Snapchat' } },
  linkedin: { icon: 'Linkedin', label: { fr: 'LinkedIn', en: 'LinkedIn' } },
